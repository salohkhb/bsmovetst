...
const ChellesCompetencesSection = () => {
...
const ChellesAdvantagesSection = () => (
...
const ChellesGettingStartedSection = () => {
  const router = useRouter();
  return (
...
const Meaux = () => {
  return (
    <div className={styles.container}>
      <ChellesEstimateSection />
      <HomePrestationsSection />
      <ChellesCompetencesSection />
      <ChellesAdvantagesSection />
      <ChellesMeubleSection />
      <ChellesGettingStartedSection />
    </div>
  )
}
