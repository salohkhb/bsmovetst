...
const SavignyLeTempleEstimateSection = () => {
  const {
    global: { screenWidth },
  } = useGlobal();
...
const SavignyLeTempleCompetencesSection = () => {
...
const SavignyLeTempleAdvantagesSection = () => (
...
const SavignyLeTempleMeubleSection = () => {
  const {
    global: { screenWidth },
  } = useGlobal();
  let router = useRouter();
...
const SavignyLeTempleGettingStartedSection = () => {
  const router = useRouter();
  return (
...
const SavignyLeTemple = () => {
  return (
    <div className={styles.container}>
      <SavignyLeTempleEstimateSection />
      <HomePrestationsSection />
      <SavignyLeTempleCompetencesSection />
      <SavignyLeTempleAdvantagesSection />
      <SavignyLeTempleMeubleSection />
      <SavignyLeTempleGettingStartedSection />
    </div>
  )
}
