export default {
  alert: {
    error: {
      ...
      existingAccount: "Cette adresse email est déjà associée à un compte.",
      missingEmail: "Merci de fournir un mail valide",
      missingPassword: "Merci de fournir un mot de passe valide",
      technicalError:
        "Une erreur technique est survenue, merci de contacter le support technique.",
    },
    success:
      "Votre demande d'inscription a été prise en compte. Vous allez recevoir un email pour la confirmation de votre compte.",
  },
  form: {
    error: {
