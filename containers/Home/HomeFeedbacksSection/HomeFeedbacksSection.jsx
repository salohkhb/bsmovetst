import styles from "./HomeFeedbacksSection.module.css";
import React, { useEffect, useRef, useState } from "react";
import Image from 'next/image';
const TESTIMONIAL_DELAY = 3000;

const HomeFeedbacksSection = (props) => {
  ...
  return (
    <div className={`${styles["section-three-main-div"]} testimonial`}>
      <h2 className={styles.h3}>Ce qu’ils pensent de nous</h2>
      <Image src='/images/google.png' width={148} height={70} />
      <div
...
export default React.memo(HomeFeedbacksSection);
