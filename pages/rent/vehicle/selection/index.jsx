...
const RentSelectionPage = ({ cookies }) => (
    <Layout cookies={cookies} title='Selection de la location' pageId='vehicle-rent-selection' withoutHeader>
        <NavHeader secondary initialStep={1} steps={NAV_HEADER_VEHICLE_RENT_STEPS} />
        <Component />
        <Footer />
    </Layout>
);
