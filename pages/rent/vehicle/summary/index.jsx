...
const RentSummary = ({ cookies }) => (
    <Layout cookies={cookies} title='Résumé de la location' pageId='vehicle-rent-summary' withoutHeader>
        <NavHeader secondary initialStep={2} steps={NAV_HEADER_VEHICLE_RENT_STEPS} />
        <Component />
        <Footer />
    </Layout>
);
