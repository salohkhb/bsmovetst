...
module.exports = function sendMailNotificationToAdmin(notifPayload) {
  const mailOptions = {
    from: '"BSMOVE" <contact@bsmove.com>', // sender address
    to: "contact@bsmove.com",
     // list of receivers
    //  eslint-disable-next-line max-len
    subject: `BSMOVE - Nouvelle demande de ${notifPayload.reason} - ${moment()
      .tz("Europe/Paris")
      .format("DD/MM")}`,
    text: `
      Nouvelle demande de ${notifPayload.reason}, rendez-vous sur l'interface administrateur.
    `,
    list: {
      unsubscribe: {
        url: baseApiUrl,
