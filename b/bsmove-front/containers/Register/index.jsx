...
const RegisterComponent = ({ handleSubmit }) => {
  ...
  function validate(values) {
    ...
    if (!values.lastName) errors.lastName = messages.form.error.required;
      ...
      errors.lastName = messages.form.lastName.error;
    if (!values.firstName) errors.firstName = messages.form.error.required;
    else if (!validators.isFirstNameValid(values.firstName))
      errors.firstName = messages.form.firstName.error;
    if (!values.password) errors.password = messages.form.error.required;
    else if (!validators.isPasswordValid(values.password))
      errors.password = messages.form.password.error;
    if (!values.phoneNumber) errors.phoneNumber = messages.form.error.required;
      ...
      errors.phoneNumber = messages.form.phoneNumber.error;
    if (!values?.address?.street) errors.street = messages.form.error.required;
    if (!values?.address?.zipCode)
      errors.zipCode = messages.form.error.required;
    else if (!validators.isZipCodeValid(values.address.zipCode))
      errors.zipCode = messages.form.zipCode.error;
    if (!values?.address?.city) errors.city = messages.form.error.required;
    if (!values?.address?.country)
      errors.country = messages.form.error.required;
            ...
            <Field
              ...
              component={(props) => (
                <GenderRadio
                  ...
                  value={genderValue}
                  onChange={(event) =>
                    handleGenderValueChange(event, props.field.onChange)
                  }
                />
              )}
            />
